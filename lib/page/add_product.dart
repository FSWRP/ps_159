...
import 'package:ps_159/page/model/product_type.dart';
  ...
  Future<void> addProductToApi() async {
    ...
    try {
      response = await http.post(
        Uri.parse('https://642021159.pungpingcoding.online/api/product'),
        headers: {
      ...
      if (response.statusCode == 200) {
        ...
        print(responseData['message'] ??
            'ไม่สามารถเพิ่มเมนูอาหารได้ กรุณาลองใหม่');

        QuickAlert.show(
          context: context,
          type: QuickAlertType.error,
          text: 'ไม่สามารถเพิ่มเมนูได้ กรุณาลองใหม่อีกครั้ง!',
          confirmBtnText: 'ตกลง',
          showConfirmBtn: false,
        );
      }
