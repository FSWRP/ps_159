...
import 'package:ps_159/page/add_product.dart';
import 'package:ps_159/page/edit_product.dart';
import 'package:ps_159/page/login.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> getList() async {
    products = [];
    var url = Uri.parse('https://642021159.pungpingcoding.online/api/product');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('P&S Restaurants'),
        backgroundColor: Color.fromARGB(255, 255, 222, 150),
        actions: [
          Row(
            children: [
              const Text('ยินดีต้อนรับคุณ '),
              Text('$username', style: const TextStyle(color: Color.fromARGB(255, 132, 15, 182))),
            ],
          ),
          IconButton(
            onPressed: () async {
  ...
  Future<void> deleteProduct(int id) async {
    var url =
        Uri.parse('https://642021159.pungpingcoding.online/api/product/$id');
  ...
  Future<void> logout(BuildContext context) async {
    ...
    var url = Uri.parse('https://642021159.pungpingcoding.online/api/logout');
