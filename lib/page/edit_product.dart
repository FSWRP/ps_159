...
class _EditProductState extends State<EditProduct> {
  ...
  Future<void> getProductById(int productId) async {
    ...
    print(productId);
    var url = Uri.parse(
        'https://642021159.pungpingcoding.online/api/product/$productId');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          // _selectedType =
          //     dropdownItems.firstWhere((type) => type.value == productType);
        });
  ...
  Future<void> updateProduct() async {
    ...
    if (_editFormKey.currentState!.validate()) {
      try {
        ...
        var url = Uri.parse(
            'https://642021159.pungpingcoding.online/api/product/$id');
